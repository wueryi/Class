<?php
namespace common\helpers\pinyin;
...
class ChinesePinyin{
	...
	public function __construct(){
		if( empty($this->ChineseCharacters) ){
		  $this->ChineseCharacters = file_get_contents(dirname(__FILE__).'/Pinyin/ChineseCharacters.dat');
		}
	}
	...
	*/	
	public function TransformUcwordsOnlyChar($input_char,$delimiter=''){
		...
		$char_without_tone = ucwords($this->TransformWithoutTone($input_char,$delimiter,true));
